...
g2 <- plot_ggnetwork_grid(num_metrics=3, Lambda=Lambda, metrics=rankdf, node_size=20, node_label=TRUE,
...
# The next step is slow! Only run this once
Lambda <- rank_aggregation_grid(num_metrics = 4, Lambda, metrics,show_bar=TRUE)
```

```{r}
# Plot with default coloring

outlist <- plot_network_grid(num_metrics=4,Lambda,metrics,node_size=5,node_label=FALSE,
                             edge_size=1,leg.pos='none',show_bar=TRUE)

plot_ggnetwork_grid(num_metrics=4,Lambda,metrics,node_size=5,node_label=FALSE,node_color='default',
                                edge_size=1,leg.pos='none',random.color=1,show_bar=FALSE)
  
# Plot with color representing distance from (1/3, 1/3, 1/3, 0)

plot_ggnetwork_grid(num_metrics=4,Lambda,metrics,node_size=5,node_label=FALSE,node_color='distance',
                    distance_from=c(1/3,1/3,1/3,0),edge_size=1,leg.pos='right',random.color=1,show_bar=FALSE)


# Plot with color representing volume

plot_ggnetwork_grid(num_metrics=4,Lambda,metrics,node_size=5,node_label=FALSE,node_color='volume',
                                edge_size=1,leg.pos='right',random.color=1,show_bar=FALSE)

# outlist <- plot_network_grid(num_metrics=4,Lambda,metrics,node_size=5,node_label=FALSE,node_color='volume',edge_size=1,leg.pos='none',show_bar=TRUE)
```
